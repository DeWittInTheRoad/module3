        ...
        <div id="parkContainer">
            ...
            <div style="display: flex;">
                <div>
                    ...
                    <a href="${detailsUrl}"><img src="img/parks/${lowerCaseImg}"
                                                 style="max-height: 350px;border-radius: 25px 25px 25px 25px;"/></a>

                </div>
                <div>

                    <a href="${detailsUrl}"><h3><c:out value="${park.parkName}"/></h3></a>
                    <div id="AllParksDescriptionContainer"><p><c:out value="${park.parkDescription}"/></p></div>
